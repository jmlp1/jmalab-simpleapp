...
// NOTE: noPublicIpPolicyId is referenced above to document intent for a real (non-F1) tier,
// where Key Vault/Storage would sit behind private endpoints. Left as a documented gap for the
// free-tier lab rather than assigned, since F1 App Service cannot reach a fully private Key
// Vault. See docs/ROADMAP.md.
